...
Usage:
    ...
    # Run evaluation
    python scripts/eval/ragas.py --game all              # All games
    python scripts/eval/ragas.py --game hollow_knight     # Single game
    python scripts/eval/ragas.py --game all --limit 5     # Quick test (5 per game)
