...
用法：
  python scripts/fetch/wiki.py cyberpunk2077
  python scripts/fetch/wiki.py --lang zh va11halla
  python scripts/fetch/wiki.py --all
  python scripts/fetch/wiki.py --lang zh --all
"""
