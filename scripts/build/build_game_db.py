...
Usage:
  python scripts/build/build_game_db.py --game terraria
  python scripts/build/build_game_db.py --game oni
  python scripts/build/build_game_db.py --game silksong
  python scripts/build/build_game_db.py --game all
"""
