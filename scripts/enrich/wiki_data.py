...
用法：
  python scripts/enrich/wiki_data.py --game oni
  python scripts/enrich/wiki_data.py --game terraria
  python scripts/enrich/wiki_data.py --game silksong
  python scripts/enrich/wiki_data.py --game all
"""
