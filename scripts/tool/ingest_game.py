...
用法：
  python scripts/tool/ingest_game.py --game oni
  python scripts/tool/ingest_game.py --game terraria
  python scripts/tool/ingest_game.py --game silksong
  python scripts/tool/ingest_game.py --game hollow_knight
